...
CREATE FOREIGN TABLE osm_source (id bigint, type text, lat double precision, lon double precision, tags json, refs bigint[], members json) SERVER osm_fdw_server;
