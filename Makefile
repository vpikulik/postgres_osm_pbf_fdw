...
reader: zdecode.o type_defs.o json_encode.o reader.o fileformat.pb-c.o osmformat.pb-c.o
	gcc -g -lprotobuf-c -lz -ljansson -o reader reader.o type_defs.o json_encode.o zdecode.o fileformat.pb-c.o osmformat.pb-c.o
